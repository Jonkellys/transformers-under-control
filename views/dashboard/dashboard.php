  ...
  <div class="page-breadcrumb ml-5">
    <div class="row">
      <div class="align-self-center">
        <h3 class="page-title d-flex flex-wrap text-truncate text-dark font-weight-medium mb-1">Good Morning, <?php echo $_SESSION['nombre'] . " " . $_SESSION['apellido']; ?></h3>
          ...
          <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
              <div class="d-inline-flex align-items-center">
                <h2 class="text-dark mb-1 font-weight-medium"><?php echo getMunCount('Installed', false); ?></h2>
              </div>
              <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Installed Transformers</h6>
            </div>
      ...
      <div class="card border-right">
        <div class="card-body">
          <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
              <div class="d-inline-flex align-items-center">
                <h2 class="text-dark mb-1 font-weight-medium"><?php echo getMunCount('Damaged', false); ?></h2>
              </div>
              <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Damaged Transformers</h6>
            </div>
            <div class="ml-auto mt-md-3 mt-lg-0">
      ...
      <div class="card border-right">
        <div class="card-body">
          <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
              <div class="d-inline-flex align-items-center">
                <h2 class="text-dark mb-1 font-weight-medium"><?php echo getMunCount('Stock', false); ?></h2>
              </div>
              <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Transformers in Stock</h6>
            </div>
            <div class="ml-auto mt-md-3 mt-lg-0">
        ...
        <div class="card-body">
          <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
              ...
              <h6 class="text-gray font-weight-normal mb-0 w-100 text-truncate">Installed Capacity</h6>
            </div>
            <div class="ml-auto mt-md-3 mt-lg-0">
    ...
    <div class="row mt-5 mb-3 d-flex flex-row justify-content-center">
      ...
      <div class="col-lg-7 d-flex align-items-strech card chart-main-box">
        <div class="card-body chart-box d-block mb-1">
          <h5 class="card-title fw-semibold">Distribution by Municipalities</h5>
            ...
            <?php
              ...
              while ($rows = $result->fetch()) {
                if($rows['O_Procedimiento'] == "Removal") {
                  $color = "text-danger";
                } else if($rows['O_Procedimiento'] == "Installation") {
                  $color = "text-success";
                } else if($rows['O_Procedimiento'] == "Stocking") {
                  $color = "text-info";
                } else if($rows['O_Procedimiento'] == "Repair") {
                  $color = "text-warning";
                }
